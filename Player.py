...
class Player(object):
    ...
    def __init__(self, FC, player_url, ol_status, room_position, region, connection_fails, role, vr, character_vehicle, mii_name, discord_name=None, lounge_name=None, mii_hex=None):
        '''
        Constructor
        '''
        self._FC = str(FC)
        self._url = str(player_url)
        ...
        self.region = region
        self.playerConnFails = connection_fails
        self.role = str(role)
        self.vr = vr
        self.character = None
        self.vehicle = None
        self.input_character_vehicle(character_vehicle)
        self.name = str(mii_name)
    ...
    def input_character_vehicle(self, character_vehicle):
        ...
        if vehicle != "" and vehicle != LONG_DASH and character != "" and character != LONG_DASH:
    ...
    def __str__(self):
        return "Name: " + str(self.name) + " - FC: " + self.get_FC() + " - Role: " + self.role
