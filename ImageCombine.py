...
from common import MIIS_DISABLED, FONT_PATH, TABLE_HEADERS_PATH
...
from common import DEFAULT_FOOTER_COLOR
FOOTER_HEIGHT = 160
...
from common import MII_SIZE_FOR_TABLE
...
DEFAULT_TEAM_TAG_FONT = f"{FONT_PATH}Roboto-Medium.ttf"
...
DEFAULT_MII_NAME_FONT = f"{FONT_PATH}Roboto-Medium.ttf"
...
AUTOGENERATED_HEADER_PATH = f"{TABLE_HEADERS_PATH}{AUTOGENERATED_FILE_NAME}"
ERRORS_HEADER_PATH = f"{TABLE_HEADERS_PATH}{ERRORS_HEADER_FILE_NAME}"
EDITS_HEADER_PATH = f"{TABLE_HEADERS_PATH}{EDITS_HEADER_FILE_NAME}"
NO_ERRORS_HEADER_PATH = f"{TABLE_HEADERS_PATH}{NO_ERRORS_HEADER_FILE_NAME}"
...
def get_blank_autotable_footer(height=FOOTER_HEIGHT, color=DEFAULT_FOOTER_COLOR):
    return create_numpy_image_with_color(dimensions=(height, MINIMUM_TABLE_WIDTH), color=color)


def generate_footer_section_for_team(miis:List[Mii], team_tag="No Tag", height=FOOTER_HEIGHT, background_color=DEFAULT_FOOTER_COLOR, forced_mii_dimension=MII_SIZE_FOR_TABLE, add_left_border=False):
