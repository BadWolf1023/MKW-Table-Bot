...
SELECT event_id, name_changes, removed_races, placement_history, forced_room_size, player_penalties, team_penalties, 
    '{}', disconnections_on_results, sub_ins, teams, rxx_list, edits, ignore_large_times, missing_player_points, event_name, 
    number_of_gps, player_setup_amount, number_of_teams, players_per_team 
